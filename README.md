...
6. If optionally sending to an Otel collector you can run the collector locally via Docker with the following command. Replace variables 
{{CLICKHOUSE_ENDPOINT}} and {{CLICKHOUSE_PASSWORD}}
